...
public class PostsPresenter implements Presenter<PostsMvpView> {
    ...
    private PostsMvpView postsMvpView;
    ...
    @Override
    public void attachView(PostsMvpView view) {
        this.postsMvpView = view;
    }

    @Override
    public void detachView() {
        this.postsMvpView = null;
    }
