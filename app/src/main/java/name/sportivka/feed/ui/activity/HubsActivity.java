...
import name.sportivka.feed.di.activity.DaggerHubsComponent;
import name.sportivka.feed.di.activity.HubsModule;
...
public class HubsActivity extends BaseActivity implements HubsMvpView {

    @Inject
    HubsPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DaggerHubsComponent.builder().hubsModule(new HubsModule(this)).build().inject(this);
        initToolbar();
